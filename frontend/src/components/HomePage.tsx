...
import { Ticket, Sparkles, Flame, ShieldCheck, Zap, Award, Film, ArrowRight, Play, Star } from 'lucide-react';
          ...
          {topMovies.map((m) => (
            <div key={m.id} className="group glass-card rounded-2xl overflow-hidden border border-white/10 flex flex-col hover:border-brand-500/50 hover:shadow-2xl transition duration-300">
              ...
              <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                <div>
                  <h3 className="font-extrabold text-white text-sm line-clamp-1">{m.title}</h3>
