...
import { Clock, Ticket, Star, Flame, Sparkles } from 'lucide-react';
...
export const MovieCard: React.FC<MovieCardProps> = ({ movie, onBookSeats }) => {
  ...
  return (
    <div className="group glass-card rounded-2xl overflow-hidden border border-white/10 flex flex-col hover:border-brand-500/50 hover:shadow-2xl hover:shadow-brand-500/20 transition-all duration-300">
      {/* Poster Header */}
      <div className="relative h-72 sm:h-80 overflow-hidden bg-dark-800">
        <img 
      ...
      <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
        ...
        <div className="flex items-center justify-between text-xs text-gray-400 pt-2 border-t border-gray-800">
          ...
          <div className="flex items-center gap-1 text-gray-400">
            ...
            <span>{movie.duration_mins}m</span>
          </div>
        </div>
