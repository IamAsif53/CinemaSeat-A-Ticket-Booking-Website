...
import { ShoppingBag, Plus, Minus, Check, ArrowRight, Sparkles, X, Coffee } from 'lucide-react';
      ...
      <div className="glass-panel w-full max-w-xl max-h-[85vh] rounded-3xl border border-white/10 shadow-2xl flex flex-col relative overflow-hidden">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-brand-400 font-extrabold font-mono mt-0.5">BDT {snack.price}</p>
                </div>
              </div>
        ...
        <div className="bg-dark-900/90 p-5 border-t border-gray-800 space-y-4 shrink-0">
          ...
          <div className="flex gap-3">
            ...
            >
              <span>Proceed to Payment (BDT {grandTotal})</span>
